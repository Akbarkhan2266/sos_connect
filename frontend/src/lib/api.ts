...
export const userApi = axios.create({ baseURL: `${API_GATEWAY_URL}/api`, withCredentials: true });
export const sosApi = axios.create({ baseURL: `${API_GATEWAY_URL}/api`, withCredentials: true });
